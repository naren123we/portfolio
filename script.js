...
document.querySelector('#mode').addEventListener('click',(e)=>{
  ...
  if(set==true){
    ...
    document.querySelector('.main-header__logo-text').style.color ="white"
    document.querySelectorAll('.main-header__navigation-link').forEach((userItem) => {
    userItem.style.color='white'
    });
    document.querySelector('#cv').style.color ="black"
    document.querySelector('#cv').style.backgroundColor ="white"
    set=false;
  }
  else{
    document.querySelector('.main-header').style.backgroundColor ="white"
    document.querySelector('.main-header__logo-text').style.color ="black"
    document.querySelectorAll('.main-header__navigation-link').forEach((userItem) => {
      userItem.style.color='black'
      });
      document.querySelector('#cv').style.color ="white"
